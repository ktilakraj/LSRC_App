...
//
//     final notificationApiModel = notificationApiModelFromMap(jsonString);

import 'dart:convert';

List<NotificationModel> notificationApiModelFromMap(String str) => List<NotificationModel>.from(json.decode(str).map((x) => NotificationModel.fromMap(x)));

String notificationApiModelToMap(List<NotificationModel> data) => json.encode(List<dynamic>.from(data.map((x) => x.toMap())));
